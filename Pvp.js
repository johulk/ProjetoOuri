...
class Pvp extends Phaser.Scene {
	...
	atualizaTabuleiro(w, h) {
		...
		this.numerodeap2 = this.add.sprite(240 * 2, 300 * 2, 'i' + dep2).setScale(0.6)
		this.numerodeap1 = this.add.sprite(790 * 2, 300 * 2, 'i' + dep1).setScale(0.6)
		textodeap1.text = dep1
    	textodeap2.text = dep2
	}
